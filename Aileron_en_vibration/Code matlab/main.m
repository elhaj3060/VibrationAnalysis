% Titre: Analyse via Matlab et Simulink d'un aileron en vibration
% Auteurs: Ahmed Massek et Simon Tanguay
...
%%%%afin de trouver les paramètres de chaque fonction on utilise stepinfo: 
stepinfo(theta1,t)
stepinfo(theta2,t)
figure(1)
hold on
%%%%Graphiques de partie 1 
subplot(2,1,1)
plot(t,theta1,'r');
grid('on')
